...
SECRET_NAME_GOOGLE_REFRESH_TOKEN=${SECRET_NAME_GOOGLE_REFRESH_TOKEN:-GOOGLE-REFRESH-TOKEN}
SECRET_NAME_GOOGLE_CLIENT_SECRET=${SECRET_NAME_GOOGLE_CLIENT_SECRET:-GOOGLE-CLIENT-SECRET}
