...
const TAPE_LIGHT_BLINK_INTERVAL_MS = Number(process.env.SWITCHBOT_TAPE_LIGHT_BLINK_INTERVAL_MS || 300);
const TAPE_LIGHT_MODE = process.env.SWITCHBOT_TAPE_LIGHT_MODE || "flashy";
